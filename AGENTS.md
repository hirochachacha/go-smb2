...
- Public APIs, except `WithContext`, must not panic for any input. Validation needed to uphold this guarantee is allowed and remains within the scope of security audits.
