...
const (
	...
	// for directory (same bits as above)
	// FILE_LIST_DIRECTORY
	// FILE_ADD_FILE
...
// CompletionFilter values (from MS-SMB2 2.2.35).
const (
...
// FILE_NOTIFY_INFORMATION Action values (from MS-FSCC 2.7.1).
const (
