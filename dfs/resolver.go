...
func (d *DFS) lookupReferral(path string, checkExpiry bool) (*referralEntry, string) {
	d.mu.Lock()
	defer d.mu.Unlock()
...
func (d *DFS) execute(ctx context.Context, path string, action routeAction) (any, error) {
	if ctx == nil {
		panic("nil context")
	}
	if d == nil {
